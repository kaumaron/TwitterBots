...
AVOID = ["monty", "leather", "skin", "bag", "blood", "bite", "dailym.ai", "@MailOnline", "@ipobworldnews", "DailyMail", "@DailyMail", "dailym"]
terms = [
...
class PyStreamListener(StreamListener):
    def on_data(self, data):
        ...
        try:
            ...
            if re.search(r'dailym.ai/.*', tweet['text']) or re.search(r'thebiafratimes.co/.*',tweet['text']) or re.search(r'gab.ai', tweet['text']):
                publish = False
